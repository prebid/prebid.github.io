...
|------------|----------|--------------|--------|
|mimes|array of strings|(Required) Specifies the video content MIME types supported; for example, video/x-ms-wmv and video/x-flv.|["video/x-ms-wmv","video/x-flv"]|
...
|w|integer|(Recommended) Specifies the width of the video player, in pixels.|640|
|h|integer|(Recommended) Specifies the height of the video player, in pixels.|480|	
