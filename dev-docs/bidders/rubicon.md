...
|-------------|---------|--------------------|-----------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|------------------|
| `accountId`    | required           | The publisher account ID                                                                                                    | `4934`, `'4934'`                                                                    | `integer` or `string`         |
| `siteId`       | required           | The site ID                                                                                                                 | `13945`, `'13945'`                                                                  | `integer` or `string`         |
| `zoneId`       | required           | The zone ID                                                                                                                 | `23948`, `'23948'`                                                                  | `integer` or `string`         |
