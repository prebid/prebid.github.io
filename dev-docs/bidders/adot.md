...
| `minduration`     | required                                  | Integer that defines the minimum video ad duration in seconds.                                                                                                                                                                               | `integer`        |
| `maxduration`     | required                                  | Integer that defines the maximum video ad duration in seconds.                                                                                                                                                                               | `integer`        |
