...
| `video`           | optional | Object containing video targeting parameters. See [Video Object](#cleanmedianet-video-object) for details. | `video: { playback_method: ['auto_play_sound_off'] }` | `object` |
