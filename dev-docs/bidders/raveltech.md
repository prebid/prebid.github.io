...
| `video`                                         | optional | Object containing video targeting parameters.  See [Video Object](/dev-docs/bidders/appnexus.mdappnexus-video-object) for details.                                                                        | `video: { playback_method: ['auto_play_sound_off'] }` | `object`         |
| `app`                                           | optional | Object containing mobile app parameters.  See the [App Object](/dev-docs/bidders/appnexus.mdappnexus-app-object) for details.                                                                      | `app : { id: 'app-id'}`                               | `object`         |
