...
| `dctr`		| optional | Deal Custom Targeting <br/> (Value configured only in the 1st adunit will be passed on. < br/> Values in subsequent adunits will be ignored.) | `'key1=123|key2=345'` 	   | `string` |
