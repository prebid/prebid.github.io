...
| `deals`    | optional | PMP deals  <br/> (Values from each slots will be passed per slot. An array of strings only. Each deal-id should be a string.) | `[ 'deal-id-5', 'deal-id-6', 'deal-id-7' ]`     | `array of strings` |
