...
| `pre_market_bids`    | optional | Pre-market bids that should be included in the SpotX auction.                                                                                                 | `[{vast_url: 'http://example.com/vast.html', deal_id: '12345.abcde.1234', price: 1.23, currency: 'USD'},{vast_string: '<VAST...</VAST>', deal_id: '12345.abcde.1235`, price: 2.34, currency: 'USD'}] | `array`     |
