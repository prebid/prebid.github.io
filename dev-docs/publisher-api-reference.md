...
`pbjs_debug=true` to the URL's query string. e.g. <a href="{{ site.github.url }}/dev-docs/examples/basic-example.html">Prebid basic demo.</a> See [Prebid.js troubleshooting tips](/dev-docs/troubleshooting-tips.html) for more information.
