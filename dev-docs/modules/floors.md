...
| enforcement.enforceBidders | array of strings | (PBJS 10.11+) Controls which bidders should have JavaScript floor enforcement applied when `enforcement.enforceJS` is `true`. Use bidder codes or `"*"` for all bidders. | `["*"]` |
