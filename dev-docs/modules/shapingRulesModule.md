...
| `domainIn`        | array of strings (domains)                                            | true if any supplied domain matches publisher.domain or domain.                                                                                                                                                                       |                                                                                                                                                                                                                                   |
| `bundleIn`        | array of strings (bundles)                                            | true if any supplied value matches app.bundle.                                                                                                                                                                                        |
