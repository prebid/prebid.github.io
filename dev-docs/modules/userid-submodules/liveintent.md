...
The attributes 'uid2', 'medianet', 'magnite', 'bidswitch', 'pubmatic', 'openx', 'sovrn' and 'index' are treated specially by LiveIntent's user id sub-module. Each of these four attributes will result in a separate id returned by the sub-module.
...
Note that 'uid2' is exposed as part of 'lipb' as well as separately as 'uid2'. 'medianet', 'magnite', 'bidswitch', 'pubmatic', 'openx', 'sovrn' and 'index' behave the same way.
