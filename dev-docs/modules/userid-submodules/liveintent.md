...
To add the functionality of LiveIntent Identity sub-module to your _Prebid.js_ package, use the following command:
...
There are two possible modes depending on the configuration of the liveconnect module:
