...
| [**ConsentManagement**](/dev-docs/modules/consentManagement.html) | Facilitates collecting/passing consent information in support of privacy regulations: EU GDPR and US Privacy (CCPA). |
