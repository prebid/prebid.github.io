...
| [**Universal ID**]({{site.baseurl}}/dev-docs/modules/universalId.html) | Allows the publisher to work with one of several cross-vendor user ID systems. |
| [**Publisher Common ID**]({{site.baseurl}}/dev-docs/modules/pubCommonId.html) | *DEPRECATED - use the Universal ID module* Adds a persisted user ID in the publisher's domain. |
