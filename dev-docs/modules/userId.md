...
| params.extraRequestedAttributes | Optional | Array[String] | Extra attributes that should be resolved by the identity resolution endpoint | `[ 'uid2' ]` |
