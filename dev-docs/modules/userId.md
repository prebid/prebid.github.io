    ...
    userSync: {
        userIds: [{
            ...
            params: {
                ...
                // use3P: true/false    // If you want to use 3P endpoint to retrieve envelope. If you do not set this property to true, 3p endpoint will not be fired. By default this property is undefined and 3p request will not be fired.
            },
            storage: {
                type: "cookie",
