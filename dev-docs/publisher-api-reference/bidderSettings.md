...
The automatically derived inverse function is correct only when `bidCpmAdjustment` is linear. If it isn't, the inverse should also be provided through `inverseCpmAdjustment`. For example:
