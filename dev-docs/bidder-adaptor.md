...
* *Adapters should not be modifying the DFP slots directly*: Accessing `googletag.pubads().getSlots()` to modify or set targeting directly on slots is not permitted.
