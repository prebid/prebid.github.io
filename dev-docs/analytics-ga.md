...
| 203ms | Microsoft's bid came back with a CPM of $2.314 and a latency of 188ms. | Event 1: Category=`Prebid.js Bids`, Action=`Bids`, Label=`msft`, Value=231.<br/>Event 2: Category=`Prebid.js Bids`, Action=`Bid Load Time`, Label=`msft`, Value=188 |
