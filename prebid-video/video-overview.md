...
- Long-form - Long-form video content always has a content arc with a beginning, middle and end and has a duration of . Ads display in an ad pod, a grouping of individual ads that appear either in the beginning, end or during the video content. As the publisher you must provide your own video player that can be used to render the ads.
