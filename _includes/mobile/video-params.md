...
Not needed for Instream video integration, which uses plcmnt=1.
...
Notes:
- `PrebidAdUnit`, `VideoInterstitialAdUnit` and `RewardedVideo` will default to plcmnt=3 if no placement value is supplied.
