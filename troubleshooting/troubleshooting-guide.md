...
If you're using Prebid Server (i.e. the [s2sConfig](/dev-docs/publisher-api-reference/setConfig/setConfig.html#setConfig-Server-to-Server) option), you can force it to respond with a particular canned response on any page by defining a storedAuctionResponse ID on the javascript console:
