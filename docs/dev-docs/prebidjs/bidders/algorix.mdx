...
AlgoriX adapter requires setup and approval from the AlgoriX team, even for existing in-app developers and publishers. Please reach out to your account team or email to [mailto:prebid@algorix.co](prebid@algorix.co) for more information.
