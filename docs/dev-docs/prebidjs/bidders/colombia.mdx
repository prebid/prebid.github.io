...
The Colombia bidding adapter requires setup and approval before implementation. Please reach out to [mailto:adserver@colombiaonline.com](adserver@colombiaonline.com) for more details.
