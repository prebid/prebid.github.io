...
NetAddiction header bidding adapter connects with NetAddiction demand sources to fetch bids for network ID. Please reach out to your account manager or [mailto:publishers-support@netaddiction.it](publishers-support@netaddiction.it) for more information.
