...
For further information, please contact [mailto:adops@beachfront.com](adops@beachfront.com).
...
| `mimes` | optional | Array of strings listing supported MIME types. | `["video/mp4", "application/javascript"]` | `Arraystring` |
