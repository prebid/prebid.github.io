...
The AdPluto DSP bidding adapter requires setup and approval before implementation. Please reach out to [mailto:support@adpluto.com](support@adpluto.com) for more details.
