...
SharedID: We need you to include the [SharedID module](/dev-docs/prebidjs/next/modules/userid-submodules/sharedid) in order to bid effectively on your inventory.
