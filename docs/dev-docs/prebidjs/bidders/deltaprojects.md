...
Contact [mailto:publishers@deltaprojects.com](publishers@deltaprojects.com) to get a publisher id and to agree on a currency. Delta Projects
...
|----------------|----------|--------------------------------------------------------------------------|-----------------|----------|
| `publisherId`  | required | Publisher ID from Delta Projects. Contact [mailto:publishers@deltaprojects.com](publishers@deltaprojects.com)   | `'4'`           | `string` |
