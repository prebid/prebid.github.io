...
The C1X Header Bidding adaptor requires approval from the C1X team. Please reach out to  [mailto:header-bidding@c1exchange.com](header-bidding@c1exchange.com) for more information.
