...
AdMatic GMBH header bidding adapter connects with AdMatic GMBH demand sources to fetch bids for network ID. Please reach out to your account manager or [mailto:info@admatic.de](info@admatic.de) for more information.
