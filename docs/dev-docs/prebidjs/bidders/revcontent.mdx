...
To use RevContent bidder, you need to have an existing RevContent account. To create a new account visit [https://www.RevContent.com](https://www.RevContent.com). If you are an existing user, contact the account rep for api access and information.
