...
The Cordless.co adapter requires approval and setup. Please reach out to [mailto:info@cordless.co](info@cordless.co) or visit us at [cordless.co](https://cordless.co) for more details.
