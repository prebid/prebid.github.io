...
- Specific ads.txt entries are required for the Teal bid adapter - please contact your account manager or [mailto:prebid@teal.works](prebid@teal.works) for more details.
