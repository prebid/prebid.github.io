...
| `imageUrl`          | required (for 'In-image', 'In-image Max' placeType)     | URL of the image on which the banner will be displayed.                                                   | '[https://creative.astraone.io/files/default_image-1-600x400.jpg](https://creative.astraone.io/files/default_image-1-600x400.jpg)'                                                                                                              | `string`  |
