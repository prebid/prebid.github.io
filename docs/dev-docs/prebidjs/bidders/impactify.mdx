...
The Impactify adaptator requires setup and validation from the Impactify team. Simply email us your contact details at [mailto:support@impactify.io](support@impactify.io) and we'll make sure we'll connect you within 48h.
