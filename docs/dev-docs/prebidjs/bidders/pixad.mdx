...
Pixad header bidding adapter connects with Pixad demand sources to fetch bids for network ID. Please reach out to your account manager or [mailto:prebid@pixad.com.tr](prebid@pixad.com.tr) for more information.
