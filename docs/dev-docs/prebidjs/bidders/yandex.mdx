...
:::info
:::
For detailed auction analytics, check out our [Analytics Adapter](/dev-docs/prebidjs/next/analytics/yandex).

:::info
:::
To improve the personalization of ads for publishers’ users, check out our [User ID Module](/dev-docs/prebidjs/next/modules/userid-submodules/yandex).
...
[Topics First Party Data (FPD) Module](/dev-docs/prebidjs/next/modules/topicsFpdModule) `topicsFpdModule` should be included in prebid final package to call topics API.
