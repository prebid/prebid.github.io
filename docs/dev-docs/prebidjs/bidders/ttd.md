...
:::danger
:::
Note: The Trade Desk Header Bidding adapter requires setup and approval before beginning. Please reach out to [mailto:OpenPathPublishers@thetradedesk.com](OpenPathPublishers@thetradedesk.com) for more details.
