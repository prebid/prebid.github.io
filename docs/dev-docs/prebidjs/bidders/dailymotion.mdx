...
To use the adapter with any non-test request, you first need to ask an API key from Dailymotion. Please contact us through [mailto:DailymotionPrebid.js@dailymotion.com](DailymotionPrebid.js@dailymotion.com) .
