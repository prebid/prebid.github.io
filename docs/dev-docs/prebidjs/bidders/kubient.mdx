...
The Kubient Bidder Adapter requires setup and approval before beginning. Please reach out to [mailto:prebid@kubient.com](prebid@kubient.com) for more details.
