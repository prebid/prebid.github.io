...
[Setting up Prebid Video in Google Ad Manager](/adops/setting-up-prebid-video-in-dfp).
...
If you have [set up your ad server line items and creatives correctly](/adops/setting-up-prebid-video-in-dfp), you should see an instream pre-roll video ad followed by the oceans video from the [video.js homepage](https://videojs.com/).
