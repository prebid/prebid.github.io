...
For a live example, see [Outstream with Google Ad Manager](/examples/video/outstream/pb-ve-outstream-dfp).
...
For a live example, see [Outstream without an Ad Server](/examples/video/outstream/pb-ve-outstream-no-server).
...
* [Outstream with Google Ad Manager](/examples/video/outstream/pb-ve-outstream-dfp)
* [Outstream without an Ad Server](/examples/video/outstream/pb-ve-outstream-no-server)
