...
![Prebid Diagram Image](/images/dev-docs/GA-event-categories.png)

<br />

**GA Action:**

![Prebid Diagram Image](/images/dev-docs/GA-event-actions.png)

<br />

**GA Label:**

![Prebid Diagram Image](/images/dev-docs/GA-event-labels.png)
...
![Prebid Diagram Image](/images/dev-docs/GA-custom-report.png)

This can be built by:

![Prebid Diagram Image](/images/dev-docs/GA-build-report.png)
...
![Prebid Diagram Image](/images/dev-docs/sheet-copy-dashboard.png)
<br />
<br />
...
![Prebid Diagram Image](/images/dev-docs/sheet-report-config.png)

<br />

#### Step 4. Run the Report

![Prebid Diagram Image](/images/dev-docs/sheet-run-report.png)

<br />

#### Step 5. (Optional) Schedule a Daily Report

![Prebid Diagram Image](/images/dev-docs/sheet-schedule-report.png)
