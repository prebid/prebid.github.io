...
This page has answers to some frequently asked questions about Prebid.js.  If you don't find what you're looking for here, there are other ways to [get help](/support/index).
...
If all this wasn't enough to warn you away from trying, it should work if you name the PBJS global differently for each instance (Update the value of 'globalVarName' in [https://github.com/prebid/Prebid.js/blob/master/package.json](https://github.com/prebid/Prebid.js/blob/master/package.json))
