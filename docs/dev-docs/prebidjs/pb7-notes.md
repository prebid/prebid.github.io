...
Support has been removed for `setConfig('fpd')`, `config.getLegacyFpd`, `config.convertAdUnitFpd` and related relics of legacy first party data. Publishers should use the methods described in [First Party Data](/features/firstPartyData).
...
* [First Party Data](/features/firstPartyData)
