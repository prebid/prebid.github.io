...
| `adId`              | String  | The unique identifier of a bid creative. It's used by the line item's creative as in [this example](/adops/gam-creative-banner-sbs). |                                                     `123` |
...
| `dealId`            | String  | (Optional) If the bid is [associated with a Deal](/adops/deals), this field contains the deal ID.          |                                                 "ABC_123" |
