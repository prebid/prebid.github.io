...
Returns bidResponses for the specified adUnitCode. See full documentation at [pbjs.getBidResponses()](/dev-docs/prebidjs/next/publisher-api-reference/getBidResponses).
