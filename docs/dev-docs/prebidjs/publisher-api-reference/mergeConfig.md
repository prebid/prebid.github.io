...
This is the same as [`setConfig(options)`](/dev-docs/prebidjs/next/publisher-api-reference/setConfig) except that it merges the supplied config into the structure rather than replacing it.
