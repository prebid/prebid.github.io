...
:::warning
This module requires the [TCF consent management module](/dev-docs/modules/consentManagementTcf) (the base consent module), which reads consent values from the Consent Management Platform (CMP). The TCF Control Module
will then take action based on the results. See the [base module page](/dev-docs/modules/consentManagementTcf) for general background, usage, and legal disclaimers.
:::

## Overview

The [base consent module](/dev-docs/modules/consentManagementTcf) performs the following actions:
...
The following fields related to anonymizing aspects of the auction are supported in the [`consentManagement`](/dev-docs/modules/consentManagementTcf) object:
...
* [EU GDPR Consent Management Module](/dev-docs/modules/consentManagementTcf)
...
* [CMP Best Practices](/dev-docs/cmp-best-practices)
