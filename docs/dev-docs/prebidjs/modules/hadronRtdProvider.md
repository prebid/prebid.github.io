...
[prebid@audigent.com](mailto:prebid@audigent.com).
...
([prebid@audigent.com](mailto:prebid@audigent.com)) on which version of Prebid.js supports different bidder
...
tests and work with your Audigent Prebid integration team ([prebid@audigent.com](mailto:prebid@audigent.com))
