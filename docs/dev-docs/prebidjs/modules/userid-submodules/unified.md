...
| params.url | Required for UnifiedId if not using TradeDesk | String | If specified for UnifiedId, overrides the default Trade Desk URL. | "[https://unifiedid.org/somepath?args](https://unifiedid.org/somepath?args)" |
