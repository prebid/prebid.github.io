...
Please contact [prebid@sirdata.com](mailto:prebid@sirdata.com) for more information.
...
`partnerId` and `key` should be provided by your partnering SSP or get one and your dedicated taxonomy from Sirdata ([prebid@sirdata.com](mailto:prebid@sirdata.com)). Segments ids (user-centric) and category ids (page-centric) will be provided salted and hashed : you can use them with a dedicated and private matching table.

Should you want to allow any SSP or a partner to curate your media and operate cross-publishers campaigns with our data, please ask Sirdata ([prebid@sirdata.com](mailto:prebid@sirdata.com)) to whitelist him it in your account.
...
| params.partnerId                   | Integer         | Partner ID, required to get results and provided by Sirdata. Use 1 for tests and request your Id at [prebid@sirdata.com](mailto:prebid@sirdata.com)                | Mandatory. Default 1                                                                                     |
| params.key                         | Integer         | Key linked to Partner ID, required to get results and provided by Sirdata. Use 1 for tests and request your key at [prebid@sirdata.com](mailto:prebid@sirdata.com) | Mandatory. Default 1                                                                                     |
...
| curationId     | String          | Specify the curation ID of the bidder. Provided by Sirdata, request it at [prebid@sirdata.com](mailto:prebid@sirdata.com) | Optional. Default curation ids are specified for main bidders             |
