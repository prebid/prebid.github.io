...
* Build the prebid.js file
  ...
  * Option 1: Use Prebid [Download](/download) page to build the prebid package. Ensure that you do check *Adagio* in Bidder Adapters and *Adagio Rtd Module* in Vendor-Specific Modules
