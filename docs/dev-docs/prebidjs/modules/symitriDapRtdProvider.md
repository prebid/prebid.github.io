...
Please reach out to your Symitri account representative([Prebid@symitri.com](mailto:Prebid@symitri.com)) to get provisioned on the DAP platform.
...
| apiHostname | String | Hostname provided by Symitri | Please reach out to your Symitri account representative([Prebid@symitri.com](mailto:Prebid@symitri.com)) for this value|
| apiVersion | String | This holds the API version | Please reach out to your Symitri account representative([Prebid@symitri.com](mailto:Prebid@symitri.com)) for this value |
...
"[http://localhost:9999/integrationExamples/gpt/symitridap_segments_example.html](http://localhost:9999/integrationExamples/gpt/symitridap_segments_example.html)"
