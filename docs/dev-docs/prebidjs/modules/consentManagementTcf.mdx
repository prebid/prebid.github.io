...
The optional [TCF control module](/dev-docs/modules/tcfControl) adds on these actions:
...
2. If the user hasn't consented to Purpose 1:
   - Set [deviceAccess: false](/dev-docs/publisher-api-reference/setConfig#setConfig-deviceAccess)
   - Don't enable [userSync](/dev-docs/publisher-api-reference/setConfig#setConfig-Configure-User-Syncing)
...
- [TCF Control Module](/dev-docs/modules/tcfControl)
