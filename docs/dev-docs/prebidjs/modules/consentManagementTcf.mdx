...
The optional [TCF control module](/dev-docs/prebidjs/next/modules/tcfControl) adds on these actions:
...
2. If the user hasn't consented to Purpose 1:
   - Set [deviceAccess: false](/dev-docs/prebidjs/next/publisher-api-reference/setConfig#setConfig-deviceAccess)
   - Don't enable [userSync](/dev-docs/prebidjs/next/publisher-api-reference/setConfig#setConfig-Configure-User-Syncing)
   - Don't enable [userId](/dev-docs/modules/userId) modules
...
- [TCF Control Module](/dev-docs/prebidjs/next/modules/tcfControl)
