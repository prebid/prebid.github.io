...
> **Warning!**
>
> The **idWardRtdProvider** module has been renamed to [anonymisedRtdProvider](/dev-docs/prebidjs/next/modules/anonymisedRtdProvider) in light of the company's rebranding.
...
Please reach out to Id Ward representative([support@id-ward.com](mailto:support@id-ward.com)) if you have any questions or need further help to integrate Prebid, idWardRtdProvider, and Id Ward Pixel
