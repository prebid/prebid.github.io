...
If you are using the [TCF control module](/dev-docs/prebidjs/next/modules/tcfControl) to enforce purpose 7, by default this module will be blocked when GDPR is in scope.
