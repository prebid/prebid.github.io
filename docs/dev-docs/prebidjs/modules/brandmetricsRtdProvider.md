...
This module is intended to be used by brandmetrics ([https://brandmetrics.com](https://brandmetrics.com)) partners and sets targeting keywords to bids if the browser is eligeble to see a brandmetrics survey.
