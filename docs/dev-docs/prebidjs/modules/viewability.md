...
- Aims to provide (and in some ways extend) functionality of [https://github.com/InteractiveAdvertisingBureau/openvv-html](https://github.com/InteractiveAdvertisingBureau/openvv-html) , but keeping the size to the bare minimun (openvv-html is ~26kb in size).
