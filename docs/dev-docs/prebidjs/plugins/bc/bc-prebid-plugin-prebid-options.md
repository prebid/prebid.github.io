...
[https://cdn.jsdelivr.net/npm/prebid.js@latest/dist/not-for-prod/prebid.js](https://cdn.jsdelivr.net/npm/prebid.js@latest/dist/not-for-prod/prebid.js)
...
See "aliasBidder" at [Prebid.org](/dev-docs/publisher-api-reference) for details.
...
When you are defining all options to the prebid plugin directly on the page, you may use a JSON Object using same syntax described under "bidderSettings" on [Prebid.org](/dev-docs/publisher-api-reference).
...
See "bidderSettings" at [Prebid.org](/dev-docs/publisher-api-reference) for details.
...
[https://acdn.adnxs.com/video/plugins/bc/prebid/bc_prebid_vast_plugin.min.js](https://acdn.adnxs.com/video/plugins/bc/prebid/bc_prebid_vast_plugin.min.js)
