...
- [iOS - Targeting Parameters](/dev-docs/prebid-mobile/pbm-api/ios/pbm-targeting-ios)
- [Android - Targeting Parameters](/dev-docs/prebid-mobile/pbm-api/android/pbm-targeting-android)
...
- See [iOS Global Parameters](/dev-docs/prebid-mobile/pbm-api/ios/pbm-targeting-ios)
- See [Android Global Parameters](/dev-docs/prebid-mobile/pbm-api/android/pbm-targeting-android)
...
- [Prebid Privacy Resources](/support/privacy-resources)
- Global parameters [iOS](/dev-docs/prebid-mobile/pbm-api/ios/pbm-targeting-ios), [Android](/dev-docs/prebid-mobile/pbm-api/android/pbm-targeting-android)
