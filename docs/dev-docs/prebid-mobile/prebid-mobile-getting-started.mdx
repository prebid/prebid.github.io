...
:::info
If this is your first time working with header bidding, we recommend that you read [What is Prebid?](/intro) before diving into Prebid Mobile.
:::
...
<iframe frameBorder="0"
        ...
        src="https://player.vimeo.com/video/945961210?badge=0&autopause=0&player_id=0&app_id=58479"
        title="Prebid Mobile Impression Flow" />
</div>

Further Content:

- [Transcript of this video](/dev-docs/prebid-mobile/prebid-mobile-video-flow)
...
<iframe frameBorder="0"
        allow="autoplay; fullscreen; picture-in-picture"
        style={{position: "absolute", top: 0, left: 0, width: "100%", height: "100%"}}
        src="https://player.vimeo.com/video/948475423?badge=0&autopause=0&player_id=0&app_id=58479"
        title="Prebid Mobile Planning Guide" />
</div>

Further Content:

- [Transcript of this video](/dev-docs/prebid-mobile/prebid-mobile-video-planning)
- [Getting Started with Prebid Mobile](/dev-docs/prebid-mobile/prebid-mobile-getting-started)
...
See the [Prebid Server documentation](/dev-docs/prebid-server/overview/prebid-server-overview) for more information on [setting up your own server host](/dev-docs/prebid-server/hosting/pbs-hosting).
...
Working with your Prebid Server host, you will need to create at least one "account settings" block. Prebid Server calls this a [top-level stored request](/dev-docs/prebid-server/features/pbs-storedreqs). Each top-level stored request contains parameters that are global to the entire auction, not just
...
If you want to verify the SDK integration with test placements, you can add some [Stored Responses](/troubleshooting/pbs-troubleshooting#stored-responses) to your Prebid Server:
...
- [Set Up Line Items for Google Ad Manager](/adops/step-by-step)
- [Price Granularity](/adops/price-granularity) Additional details to help you ensure your line items are set up to target bid prices at an appropriate level of granularity.
...
- [iOS Code Integration](/dev-docs/prebid-mobile/pbm-api/ios/code-integration-ios)
- [Android Code Integration](/dev-docs/prebid-mobile/pbm-api/android/code-integration-android)
...
- [How Prebid Server works with Prebid SDK](/dev-docs/prebid-server/use-cases/pbs-sdk)
