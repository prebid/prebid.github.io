...
**Review the [Prebid.org Dr. Prebid Terms of Use](/dev-docs/prebid-mobile/dr-prebid-tou).**
...
![Dr. Prebid Setup](/images/prebid-mobile/dr-prebid-setup.png)
...
![Dr. Prebid Setup](/images/prebid-mobile/dr-prebid-summary.png)
...
| Passed        |     | Failed      |
|:-----------:| --- |:-----------:|
| ![Dr. Prebid Validation Test Passed](/images/prebid-mobile/dr-prebid-pass.png) |     | ![Dr. Prebid Validation Test Failed](/images/prebid-mobile/dr-prebid-fail.png) |
...
- Ensure that your Prebid Server Configuration is correct. See [Getting Started with Prebid Mobile](/dev-docs/prebid-mobile/prebid-mobile-getting-started#configure-prebid-server) for more information.
...
- Make sure your ad unit has been registered correctly. (See [Code Integration](/dev-docs/prebid-mobile/prebid-mobile-pbs#configure-prebid-server) for more information.)
...
- **Ad unit registered**
  Be sure you’ve implemented your ad unit code correctly. See [Ad Unit Setup for iOS](/dev-docs/prebid-mobile/pbm-api/ios/code-integration-ios) or [Ad Unit Setup for Android](/dev-docs/prebid-mobile/pbm-api/android/code-integration-android) for information.
- **Request to Prebid Server sent**  
  Make sure your account ID and configuration ID were entered correctly on the Setup screen. For more on integrating with Prebid Server see [Getting Started with Prebid Mobile](/dev-docs/prebid-mobile/prebid-mobile-pbs).
- **Prebid Server response received**  
...
- [Getting Started with Prebid Mobile](/dev-docs/prebid-mobile/prebid-mobile-pbs)
- [AdOps – Before You Start](/adops/before-you-start)
