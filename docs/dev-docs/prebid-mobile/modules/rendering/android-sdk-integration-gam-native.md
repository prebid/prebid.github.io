...
[See Native Ads Guideline page](rendering-native-guidelines) for more details about SDK integration and supported ad types.
...
* **configId** - an ID of a [Stored Impression](/dev-docs/prebid-server/features/pbs-storedreqs) on the Prebid server
...
See more NativeAdConfiguration options in the [NativeAdConfiguration guide](rendering-native-ad-configuration).
