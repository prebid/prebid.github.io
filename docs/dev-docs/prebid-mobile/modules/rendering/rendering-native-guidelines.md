...
1. Configure the Native Ad using [NativeAdConfiguration](rendering-native-ad-configuration).
...
3. Configure the Native Ad unit using [NativeAdConfiguration](rendering-native-ad-configuration).
    * Provide the list of [Native Assets](#components) representing the ad's structure.
    * Tune other general properties of the ad.
...
![Rendering with GAM as the Primary Ad Server](/images/prebid-mobile/modules/rendering/Native-Styles-Primary-Ad-Server.png)
...
In order to prepare the valid layout follow the instructions in the Prebid docs for [Google Ad Manager](/adops/gam-native).
...
![Rendering with GAM as the Primary Ad Server](/images/prebid-mobile/modules/rendering/Native-Styles-Prebid.png)
