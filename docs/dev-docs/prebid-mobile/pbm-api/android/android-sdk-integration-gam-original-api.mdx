...
If you do not have GMA SDK in the app, refer to the [Google Integration Documentation](https://developers.google.com/ad-manager/mobile-ads-sdk/android/quick-start).

### Alternative Approaches

Another way to integrate GAM into your app is with the [Prebid-Rendered Integration](/dev-docs/prebid-mobile/modules/rendering/android-sdk-integration-gam).
...
### [Format: HTML Banner](/dev-docs/prebid-mobile/recipes/subrecipes/android/gam-bidding-only-html-banner)

### [Format: Interstitial Banner](/dev-docs/prebid-mobile/recipes/subrecipes/android/gam-bidding-only-interstitial-banner)

### [Format: Instream Video](/dev-docs/prebid-mobile/recipes/subrecipes/android/gam-bidding-only-video-instream)

### [Format: Non-Instream Video](/dev-docs/prebid-mobile/recipes/subrecipes/android/gam-bidding-only-video-outstream)

### [Format: Interstitial Video](/dev-docs/prebid-mobile/recipes/subrecipes/android/gam-bidding-only-interstitial-video)

### [Format: Rewarded Video Ad](/dev-docs/prebid-mobile/recipes/subrecipes/android/gam-bidding-only-rewarded-video)

### [Format: Native In-App](/dev-docs/prebid-mobile/recipes/subrecipes/android/gam-bidding-only-native-in-app)

### [Format: Native In-Webview](/dev-docs/prebid-mobile/recipes/subrecipes/android/gam-bidding-only-native-in-webview)

### [Format: Multiformat (Banner+Video+InApp Native)](/dev-docs/prebid-mobile/recipes/subrecipes/android/gam-bidding-only-multiformat)

### [Format: Multiformat Interstitial (Banner+Video)](/dev-docs/prebid-mobile/recipes/subrecipes/android/gam-bidding-only-multiformat-interstitial)
