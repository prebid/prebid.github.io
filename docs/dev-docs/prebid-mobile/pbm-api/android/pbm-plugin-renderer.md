...
![Plugin Renderer big picture](/images/prebid-mobile/prebid-plugin-renderer.png)
...
![Plugin Renderer big picture](/images/prebid-mobile/prebid-plugin-renderer-ad-view-injection.png)
...
The Plugin Renderer feature does not work with [GAM Original API](/dev-docs/prebid-mobile/pbm-api/android/android-sdk-integration-gam-original-api) since the ad rendering does not happen in the Prebid SDK but externally. Despite that if you are using the regular GAM integration it will work fine.
...
![Plugin Event Listener big picture](/images/prebid-mobile/prebid-plugin-renderer-event-listeners.png)
