...
Your Prebid Server team will tell you whether this is required or not and if so, the value. See the initialization page for [Android](/dev-docs/prebid-mobile/pbm-api/android/code-integration-android).
...
The Prebid SDK timeout. When this number of milliseconds passes, the Prebid SDK returns control to the ad server SDK to fetch an ad without Prebid bids. See the initialization page for [Android](/dev-docs/prebid-mobile/pbm-api/android/code-integration-android).
...
Prebid SDK provides a number of properties in the [Targeting class](/dev-docs/prebid-mobile/pbm-api/ios/pbm-targeting-ios#targeting-class-properties-and-
...
Prebid SDK provides a number of methods in the [Targeting class](/dev-docs/prebid-mobile/pbm-api/ios/pbm-targeting-ios#targeting-class-properties-and-methods) for setting content-oriented First Party Data.
