...
If you're looking for bidder adapter parameters, see [Bidders' Params](/dev-docs/pbs-bidders).
...
1. Privacy Modules - these are more limited, plugging into the [Activity Controls](/dev-docs/prebid-server/features/pbs-activitycontrols) system to delegate decisions about potentially privacy-sensitive scenarios.
...
|---------------------+--------------+------+--------+----------|
| [**ORTB2 Blocking**](/dev-docs/prebid-server/pbs-modules/ortb2-blocking) | Support bidders that aren't full-service SSPs. | general | <img alt="check" src="/images/icons/icon-check-green.png" width="30"> | <img alt="check" src="/images/icons/icon-check-green.png" width="30"> |
| [**Confiant Ad Quality**](/dev-docs/prebid-server/pbs-modules/confiant-ad-quality) | Scans bid responses for security and quality issues. | general | | <img alt="check" src="/images/icons/icon-check-green.png" width="30"> |
| [**US Gen Privacy**](/dev-docs/prebid-server/features/pbs-usgen) | Links with the [Activity Controls](/dev-docs/prebid-server/features/pbs-activitycontrols) to process GPP strings to determine whether an activity should be allowed. | privacy | | <img alt="check" src="/images/icons/icon-check-green.png" width="30"> |
| [**US Custom Logic Privacy**](/dev-docs/prebid-server/features/pbs-uscustomlogic) | Similar to the `US Gen Privacy` module, but publishers define their own interpretation of the GPP string. | privacy | | <img alt="check" src="/images/icons/icon-check-green.png" width="30"> |
| [**Richmedia Filter**](/dev-docs/prebid-server/pbs-modules/richmedia) | Can filter MRAID creatives from the bid stream. | validation | | <img alt="check" src="/images/icons/icon-check-green.png" width="30"> |
| [**51Degrees Device Detection**](/dev-docs/prebid-server/pbs-modules/51degrees-device-detection) | Enriches an incoming OpenRTB request with [51Degrees Device Data](https://51degrees.com/documentation/_device_detection__overview.html) | general | <img alt="check" src="/images/icons/icon-check-green.png" width="30"> | <img alt="check" src="/images/icons/icon-check-green.png" width="30"> |
| [**Greenbids Real Time Data**](/dev-docs/prebid-server/pbs-modules/greenbids-real-time-data) | Filters out bidders that are not expected to bid on this request, saving money and carbon. | general | | <img alt="check" src="/images/icons/icon-check-green.png" width="30"> |
| [**Request Correction**](/dev-docs/prebid-server/pbs-modules/request-correction) | Apply optional corrections to bid requests. | general | | <img alt="check" src="/images/icons/icon-check-green.png" width="30"> |
| [**Response Correction**](/dev-docs/prebid-server/pbs-modules/response-correction) | Apply optional corrections to bid responses. | general | | <img alt="check" src="/images/icons/icon-check-green.png" width="30"> |
...
To get reporting on the test results, analytics adapters will need to read the [analytics tag](/dev-docs/prebid-server/developers/module-atags) created by the A/B test, which looks like this:
...
relevant 'Activity' using the `privacyreg` directive as described in the [Activity Control reference](/dev-docs/prebid-server/features/pbs-activitycontrols).

## Further Reading

- [Developing a Prebid Server General Module](/dev-docs/prebid-server/developers/add-a-module)
- [Developing a Prebid Server Privacy Module](/dev-docs/prebid-server/developers/add-a-privacy-module)
- [Prebid Server Features](/dev-docs/prebid-server/features/pbs-feature-idx)
