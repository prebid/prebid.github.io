...
* Responsibility for understanding the legal implications of ad tech in your marketplace. PBS has built-in configurable support for [several privacy regulations](/dev-docs/prebid-server/features/pbs-privacy), but you need to understand and configure them with help from your lawyers.
...
* [Prebid Server (Go)](/dev-docs/prebid-server/versions/pbs-versions-go) - the original Prebid Server is written in the Go language.
* [Prebid Server (Java)](/dev-docs/prebid-server/versions/pbs-versions-java) - Prebid Server with a Java language port.

To choose between them, see the [Prebid Server version overview](/dev-docs/prebid-server/versions/pbs-versions-overview) and the [FAQ](/faq/prebid-server-faq#why-are-there-two-versions-of-prebid-server-are-they-kept-in-sync).
...
![Prebid Server Hardware Layout](/images/prebid-server/pbs-hardware-layout.png)
...
Account information and StoredRequests are stored in a [database](/dev-docs/prebid-server/hosting/pbs-database)
...
this mailing list by emailing [prebid-server@prebid.org](mailto:prebid-server@prebid.org). It's low volume.
...
* [Prebid Server Database](/dev-docs/prebid-server/hosting/pbs-database)
* [PBS-Go](/dev-docs/prebid-server/versions/pbs-versions-go)
* [PBS-Java](/dev-docs/prebid-server/versions/pbs-versions-java)
* [Bidder-specific setup guidelines](/dev-docs/prebid-server/hosting/bidder-specific-guidelines)
