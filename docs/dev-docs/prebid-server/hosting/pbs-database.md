...
- [stored requests](/dev-docs/prebid-server/features/pbs-storedreqs): blocks of JSON that define how PBS responds to mobile and AMP requests.
...
- [Hosting a PBS cluster](/dev-docs/prebid-server/overview/prebid-server-overview)
