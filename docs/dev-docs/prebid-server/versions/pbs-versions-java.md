...
<li>Are satisified with the <a href="/dev-docs/prebid-server/features/pbs-feature-idx">feature set</a> and available <a href="https://github.com/prebid/prebid-server-java/tree/master/src/main/resources/bidder-config">bid adapters</a>.</li>
</ul>

</div>
<div class="col-md-6 centered">

<img src="/images/prebid-server/java-logo.png" width="50" alt="Java Logo">
...
See [Hosting your own Prebid Server](/dev-docs/prebid-server/hosting/pbs-hosting) for
important architectural considerations, then follow the instructions for [Installing PBS-Java](/dev-docs/prebid-server/developers/installing-java).
...
- [Building an Analytics Adapter](/dev-docs/prebid-server/developers/pbs-build-an-analytics-adapter#adding-an-analytics-adapter-in-pbs-java)

## See Also

- [Prebid Server - Go](/dev-docs/prebid-server/versions/pbs-versions-go)
- [Endpoint reference](/dev-docs/prebid-server/endpoints/pbs-endpoint-overview)
