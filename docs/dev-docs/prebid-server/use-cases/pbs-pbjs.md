...
![Prebid Server Web Banner Architecture](/images/flowcharts/prebid-server/pbjs-server-flow.png)
...
![Prebid Server Web Video Architecture](/images/flowcharts/prebid-server/pbjs-video-server-flow.png)
