...
![Prebid AMP Architecture](/images/flowcharts/prebid-server/pbs-amp-flow.png)
...
As described in the [Prebid AMP Implementation Guide](/dev-docs/prebidjs/next/show-prebid-ads-on-amp-pages), `amp-ad` tags are placed in the AMP content.
...
Prebid Server's first job on the [/openrtb2/amp endpoint](/dev-docs/prebid-server/endpoints/openrtb2/pbs-endpoint-amp) is to create an OpenRTB block to pass to the adapters.
...
in the appropriate OpenRTB locations. See the [AMP endpoint documentation](/dev-docs/prebid-server/endpoints/openrtb2/pbs-endpoint-amp)
for details.
...
Ad Server targeting data passed in through the [`/openrtb2/amp`](/dev-docs/prebid-server/endpoints/openrtb2/pbs-endpoint-amp) endpoint is merged
...
- [Prebid AMP Support](/formats/amp)
- [PBS AMP endpoint](/dev-docs/prebid-server/endpoints/openrtb2/pbs-endpoint-amp)
