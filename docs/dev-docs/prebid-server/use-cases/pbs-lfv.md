...
![Prebid Server Long Form Video](/images/flowcharts/prebid-server/pbs-lfv-flow.png)
...
4. Demand partners return a bid response to PBS. If competitive separation is enabled, PBS performs [category translation](/dev-docs/prebidjs/next/modules/categoryTranslation) on each bid. Whether category translation is required or not, the bids are stored in prebid cache.
...
## Further Reading
- [Long Form Video Endpoint](/dev-docs/prebid-server/endpoints/openrtb2/pbs-endpoint-video)
