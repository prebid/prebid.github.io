...
The supported stages are described in the [general module overview](/dev-docs/prebid-server/developers/add-a-module#2-understand-the-endpoints-and-stages) and in PBS-Core source code at the "github.com/prebid/prebid-server/hooks" package.
...
3. To supply [analytics tags](/dev-docs/prebid-server/developers/module-atags) in the `BidderRequest`, your hook implementation would return a hook result with analytics tags:
