...
- the [module overview](/dev-docs/prebid-server/developers/add-a-module)
...
The documentation must also live on the docs.prebid.org site. Please add a markdown file to [https://github.com/prebid/prebid.github.io/tree/master/prebid-server/pbs-modules](https://github.com/prebid/prebid.github.io/tree/master/prebid-server/pbs-modules)
...
The supported stages are described in the [general module overview](/dev-docs/prebid-server/developers/add-a-module#2-understand-the-endpoints-and-stages) and in PBS-Core source code at the "org.prebid.server.hooks" package.
...
3. To supply [analytics tags](/dev-docs/prebid-server/developers/module-atags) in the `RawAuctionRequestHook` you would return:
...
More test implementations for each hook can be found in unit-tests at [https://github.com/prebid/prebid-server-java/tree/master/src/test/java/org/prebid/server/it/hooks](https://github.com/prebid/prebid-server-java/tree/master/src/test/java/org/prebid/server/it/hooks) folder.
...
- [PBS Module Overview](/dev-docs/prebid-server/developers/add-a-module)
- [PBS Module Analytics Tags Conventions](/dev-docs/prebid-server/developers/module-atags)
