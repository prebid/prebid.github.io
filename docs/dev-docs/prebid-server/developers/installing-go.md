...
For the [full API reference](/dev-docs/prebid-server/endpoints/pbs-endpoint-overview)
...
Want to [add a bidding adapter](/dev-docs/prebid-server/developers/add-new-bidder-go)?
