...
module is not related to the [main workflow modules](/dev-docs/prebid-server/pbs-modules/). Rather, it's a specialized type of module that

You will want to be familiar with the following background information:

* [Privacy Modules](/dev-docs/prebid-server/developers/add-a-privacy-module)
* [Prebid Server Activity Controls](/dev-docs/prebid-server/features/pbs-activitycontrols)
...
:::info
The 'usnat' code is documented on the website as [usgen](/dev-docs/prebid-server/features/pbs-usgen)
:::
...
* [Building a privacy module](/dev-docs/prebid-server/developers/add-a-privacy-module)
