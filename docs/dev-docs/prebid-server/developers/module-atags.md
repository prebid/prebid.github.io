...
See the [Prebid Server module overview](/dev-docs/prebid-server/developers/add-a-module) for background information.
...
![Prebid Server aTags](/images/prebid-server/module-atags.png)
...
Here's an example from the [ORTB2 Blocking module](/dev-docs/prebid-server/pbs-modules/ortb2-blocking):
...
- [PBS Module Implementation](/dev-docs/prebid-server/developers/add-a-module)
