...
| --- | --- | --- | --- |
| tag_id | Required | `String` |  The `tag_id` ID must reference a [Stored BidRequest](/dev-docs/prebid-server/features/pbs-storedreqs). For a thorough description of bid request JSON, see the [/openrtb2/auction](/dev-docs/prebid-server/endpoints/openrtb2/pbs-endpoint-auction) docs. |
...
- [ext.prebid.currency](/dev-docs/prebid-server/endpoints/openrtb2/pbs-endpoint-auction#currency-support)
- [ext.prebid.aliases](/dev-docs/prebid-server/endpoints/openrtb2/pbs-endpoint-auction#bidder-aliases)
- [ext.prebid.multibid](/dev-docs/prebid-server/endpoints/openrtb2/pbs-endpoint-auction#multibid)
- etc.
...
See the [/openrtb2/auction endpoint](/dev-docs/prebid-server/endpoints/openrtb2/pbs-endpoint-auction) for a description of some common OpenRTB errors. The following is a list of AMP specific errors that could be returned:
...
- [Prebid and AMP](/formats/amp)
- [Prebid Server AMP Use Case Overview](/dev-docs/prebid-server/use-cases/pbs-amp)
- [Prebid Server First Party Data](/dev-docs/prebid-server/features/pbs-fpd)
- [Stored Requests](/dev-docs/prebid-server/features/pbs-storedreqs)
