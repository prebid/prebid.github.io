...
&nbsp;&nbsp;&nbsp;&nbsp; `_cat` indicates the industry code that is derived from the  [category translation](/dev-docs/prebidjs/next/modules/categoryTranslation).
...
* [Category Translation module](/dev-docs/prebidjs/next/modules/categoryTranslation)  
* [Freewheel module](/dev-docs/prebidjs/next/modules/freewheel)  
* [Ad Pod module](/dev-docs/prebidjs/next/modules/adpod)  
