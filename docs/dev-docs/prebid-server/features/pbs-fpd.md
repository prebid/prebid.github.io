...
Many publishers utlize data segments that apply to context and audience. See the Prebid.js writeup on [Segments and Taxonomy](/features/firstPartyData#segments-and-taxonomy) for more information.
...
- [Prebid.js First Party Data](/features/firstPartyData)
