...
Start your server and then `POST` to [`/openrtb2/auction`](/dev-docs/prebid-server/endpoints/openrtb2/pbs-endpoint-auction) with your chosen ID.
...
**Note**: However, stored requests may contain [storedresponses](/dev-docs/prebid-server/endpoints/openrtb2/pbs-endpoint-auction#stored-responses).
...
for obtaining the `Account` or `AdUnitConfig` by ID for the legacy [auction](/dev-docs/prebid-server/endpoints/openrtb2/pbs-endpoint-auction) endpoint.
...
## Related Reading
- [Stored Responses](/dev-docs/prebid-server/endpoints/openrtb2/pbs-endpoint-auction#stored-responses)
- [Hosting a PBS database](/dev-docs/prebid-server/hosting/pbs-database)
