...
description: A beginner's guide to header bidding
---

# Introduction to Header Bidding

:::success
This is a general overview of header bidding. If you're interested in an overview specific to using Prebid for your header bidding, see our [Introduction to Prebid](/content/intro).
:::
...
<div><iframe src="https://player.vimeo.com/video/820684821?h=1a3701d51a&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen title="Introduction to Header Bidding"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>

Further Reading:

- [Transcript of this video overview](/content/intro-to-header-bidding-video)
- [Header Bidding with Prebid](/content/intro#header-bidding-with-prebid)
...
![Ad Server Black Box](/images/intros/ad-server-black-box.png)
...
![Header Bidding](/images/intros/header-bidding-intro.png)
