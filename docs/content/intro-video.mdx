---
sidebar_position: 6
title: Intro to Prebid Video
description: Video transcript for Introduction to Prebid
---

# Introduction to Prebid Video Transcript

<IncludeTodo include={'{% include vimeo-iframe.html id="819942988" title="Intro to Prebid" %}'}/>

Further Content:

- [Intro to Prebid](/intro)
...
- [Introduction to Prebid Mobile](/dev-docs/prebid-mobile/prebid-mobile-video)
- [Introduction to Prebid Server](/dev-docs/prebid-server/overview/prebid-server-overview-video)
