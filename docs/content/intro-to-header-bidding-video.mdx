---
sidebar_position: 8
title: Intro to Header Bidding Video
description: Video transcript for Introduction to Header Bidding
---

# Introduction to Header Bidding Video Transcript

<IncludeTodo include={'{% include vimeo-iframe.html id="820684821" title="820684821" %}'}/>

Further Content:

- [Intro to Header Bidding](/intro-to-header-bidding)
- [Header Bidding with Prebid](/intro#header-bidding-with-prebid)
- [All videos](/all-videos)

Related Videos:

- [Introduction to Prebid](/intro-video)
...
- [Intro to Header Bidding](/intro-to-header-bidding)
- [All video overviews](/all-videos)
