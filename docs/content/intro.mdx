...
Prebid is the leading header bidding solution. It is free and fully open source, available to any publisher who wants to implement header bidding. This introduction describes Prebid and its benefits. For a general overview of header bidding, see [Introduction to Header Bidding](/intro-to-header-bidding).
...
<div><iframe src="https://player.vimeo.com/video/819942988?h=1a3701d51a&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen  title="Intro to Prebid"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>

Further Reading:

- [Transcript of this video overview](/intro-video)
- [Introduction for Developers](/dev-docs/prebid-server/category/developers)
...
![Prebid organization](/images/intros/prebid-intro.png)
...
See [What is Prebid.js?](/dev-docs/prebidjs) for more information.
...
See [Prebid Server Overview](/dev-docs/prebid-server/overview/prebid-server-overview) for more information.
...
See [Prebid Mobile Overview](/dev-docs/prebid-mobile) for more information.

### SharedID

SharedId is a first party identifier. For more information, see [Prebid SharedID](/dev-docs/prebidjs/next/modules/userid-submodules/sharedid).
...
Analytics adapter modules allow you to gather analytics from Prebid.js and send them to your analytics provider (such as Google Analytics). See [Prebid.js Analytics Adapters](/analytics) for more information.

Additional modules are available that support identity, price floors, testing, currency, and much more. See [Prebid.js Module Overview](/dev-docs/prebidjs/next/category/modules) for more information.
...
![Prebid Benefits](/images/intros/prebid-benefits.png)
...
- [Introduction to Header Bidding](/intro-to-header-bidding-video)
