...
We encourage you to look at [existing modules](https://github.com/prebid/prebid-server-modules-java) for working examples. You can also ask us questions by [submitting a GitHub issue](https://github.com/prebid/prebid-server/issues/new).
...
When Prebid Server starts up, it will be configured to initialize the
...
For each user request, modules can have a default configuration or account-specific
...
- PBS-Go: doesn't currently support the module infrastructure
