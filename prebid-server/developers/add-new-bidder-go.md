...
- `config.Endpoint` is the base url of your bidding server and may be interpreted as either a literal address or as a templated macro to support or dynamic paths.
