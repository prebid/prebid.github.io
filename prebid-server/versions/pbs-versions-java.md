...
We recommend you review the [feature comparison list](/prebid-server/features/pbs-feature-idx.html) to familiarize with the differences between this and PBS-Go in deciding which version is right for you.
