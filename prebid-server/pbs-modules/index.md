...
| [**Response Correction**](/prebid-server/pbs-modules/response-correction.html) | Modifies bid responses for specific conditions. | general | | <img alt="check" src="/assets/images/icons/icon-check-green.png" width="30"> |
