...
| [**ZeroGPU Real Time Data**](/prebid-server/pbs-modules/zerogpu-rtd.html) | Enriches an incoming OpenRTB request with IAB content categories classified from the publisher's domain. | general | <img alt="check" src="/assets/images/icons/icon-check-green.png" width="30"> | |
